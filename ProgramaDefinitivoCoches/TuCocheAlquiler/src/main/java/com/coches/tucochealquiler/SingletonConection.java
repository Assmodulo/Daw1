...
public class SingletonConection {
    ...
    public static Connection crearConexion() {
        ...
        try (FileReader fichero = new FileReader("src/main/resources/com/coches/tucochealquiler/datosConexionSql.dat");
            ...
            sql = new SingletonConection(driver, url, schema, user, pass);
     ...
     */
    private SingletonConection(String driver, String url, String schema, String user, String pass) {
        this.driver = driver;
        this.url = url;
        this.schema = schema;
        this.user = user;
