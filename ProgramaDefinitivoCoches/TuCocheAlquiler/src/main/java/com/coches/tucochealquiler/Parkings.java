...
public class Parkings {
    ...
    public String toString() {
        return String.format("%-8d  %-30S  %-30S  %-50S  %-8S  %-8d %-8d %-10S %-10S %-12B ",
                this.parking_id, this.nombre, this.direccion, this.ciudad, this.codigoPostal, this.capacidad,
                this.plazasDisponibles, MyFechas.formatearLocalTimeToSql(this.horaApertura),
                MyFechas.formatearLocalTimeToSql(this.horaCierre), this.activo);
    }
}
