...
public class TiposVehiculos {
     ...
     */
    public TiposVehiculos(int idTipoVehiculo, String tipo, String descripcion, Double tarifaAdicional) {
     ...
     */
    public TiposVehiculos(String tipo, String descripcion, Double tarifaAdicional) {
        this.tipo = tipo;
        this.descripcion = descripcion;
        this.tarifaAdicional = tarifaAdicional;
    }

    //Constructor sólo para cargar un combo box

    public TiposVehiculos(int idTipoVehiculo, String tipo) {
        this.idTipoVehiculo = idTipoVehiculo;
        this.tipo = tipo;
    }
...
//Creo que para esta clase sólo tengo que definir un setter, el cual corresponde al precio de alquiler diario
    ...
    public String toComboToString(){
        return this.idTipoVehiculo + " - " + this.tipo;
    }
}
